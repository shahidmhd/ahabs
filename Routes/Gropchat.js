...
import { addAdmin, addUserToGroup, creategroup, deletegroup, editgroup, exitGroup, getAllNonPrivateGroups, getGroupMembers, removeAdmin, removeUserFromGroup, updateGroupToPrivate } from '../controllers/Groupcontroller.js';
...
router.put('/updatetoprivate/:groupId',userAuthMid,updateGroupToPrivate)
router.get('/getallgroup',userAuthMid,getAllNonPrivateGroups)
